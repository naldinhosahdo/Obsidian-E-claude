...
Registro append-only. Formato: `## [YYYY-MM-DD] operacao | Descrição`
...
A IA identifica: lacunas, temas não cobertos, fontes úteis, conexões entre páginas.
Sempre apresentar sugestões ao usuário antes de criar páginas.

### Limpeza da Wiki (`lint`)
Verificar: páginas órfãs, contradições, links quebrados, frontmatter incompleto.
